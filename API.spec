...
paddle.fluid.io.save_checkpoint ArgSpec(args=['executor', 'checkpoint_dir', 'trainer_id', 'trainer_args', 'main_program', 'max_num_checkpoints', 'lookup_table', 'ps_endpoint_list'], varargs=None, keywords=None, defaults=(None, None, 3, None, None))
paddle.fluid.io.load_checkpoint ArgSpec(args=['executor', 'checkpoint_dir', 'serial', 'main_program'], varargs=None, keywords=None, defaults=None)
paddle.fluid.io.clean_checkpoint ArgSpec(args=['checkpoint_dir', 'delete_dir'], varargs=None, keywords=None, defaults=(False,))
paddle.fluid.io.load_persist_vars_without_grad ArgSpec(args=['executor', 'dirname', 'program', 'has_model_dir'], varargs=None, keywords=None, defaults=(False,))
paddle.fluid.io.load_lookup_table_vars ArgSpec(args=['executor', 'dirname', 'program', 'pserver_id', 'table_name'], varargs=None, keywords=None, defaults=None)
paddle.fluid.io.save_persist_vars_without_grad ArgSpec(args=['executor', 'dirname', 'program'], varargs=None, keywords=None, defaults=None)
paddle.fluid.io.get_latest_checkpoint_serial ArgSpec(args=['checkpoint_dir'], varargs=None, keywords=None, defaults=None)
...
paddle.fluid.layers.im2sequence ArgSpec(args=['input', 'filter_size', 'stride', 'padding', 'name'], varargs=None, keywords=None, defaults=(1, 1, 0, None))
...
paddle.fluid.layers.get_places ArgSpec(args=['device_count', 'device_type'], varargs=None, keywords=None, defaults=(None, None))
paddle.fluid.layers.prior_box ArgSpec(args=['input', 'image', 'min_sizes', 'max_sizes', 'aspect_ratios', 'variance', 'flip', 'clip', 'steps', 'offset', 'name'], varargs=None, keywords=None, defaults=(None, [1.0], [0.1, 0.1, 0.2, 0.2], False, False, [0.0, 0.0], 0.5, None))
paddle.fluid.layers.multi_box_head ArgSpec(args=['inputs', 'image', 'base_size', 'num_classes', 'aspect_ratios', 'min_ratio', 'max_ratio', 'min_sizes', 'max_sizes', 'steps', 'step_w', 'step_h', 'offset', 'variance', 'flip', 'clip', 'kernel_size', 'pad', 'stride', 'name'], varargs=None, keywords=None, defaults=(None, None, None, None, None, None, None, 0.5, [0.1, 0.1, 0.2, 0.2], True, False, 1, 0, 1, None))
...
paddle.fluid.optimizer.SGDOptimizer.create_optimization_pass ArgSpec(args=['self', 'parameters_and_grads', 'loss', 'startup_program'], varargs=None, keywords=None, defaults=(None,))
paddle.fluid.optimizer.SGDOptimizer.global_learning_rate ArgSpec(args=['self', 'program'], varargs=None, keywords=None, defaults=(None,))
...
paddle.fluid.optimizer.MomentumOptimizer.create_optimization_pass ArgSpec(args=['self', 'parameters_and_grads', 'loss', 'startup_program'], varargs=None, keywords=None, defaults=(None,))
paddle.fluid.optimizer.MomentumOptimizer.global_learning_rate ArgSpec(args=['self', 'program'], varargs=None, keywords=None, defaults=(None,))
...
paddle.fluid.optimizer.AdagradOptimizer.create_optimization_pass ArgSpec(args=['self', 'parameters_and_grads', 'loss', 'startup_program'], varargs=None, keywords=None, defaults=(None,))
paddle.fluid.optimizer.AdagradOptimizer.global_learning_rate ArgSpec(args=['self', 'program'], varargs=None, keywords=None, defaults=(None,))
...
paddle.fluid.optimizer.AdamOptimizer.create_optimization_pass ArgSpec(args=['self', 'parameters_and_grads', 'loss', 'startup_program'], varargs=None, keywords=None, defaults=(None,))
paddle.fluid.optimizer.AdamOptimizer.global_learning_rate ArgSpec(args=['self', 'program'], varargs=None, keywords=None, defaults=(None,))
...
paddle.fluid.optimizer.AdamaxOptimizer.create_optimization_pass ArgSpec(args=['self', 'parameters_and_grads', 'loss', 'startup_program'], varargs=None, keywords=None, defaults=(None,))
paddle.fluid.optimizer.AdamaxOptimizer.global_learning_rate ArgSpec(args=['self', 'program'], varargs=None, keywords=None, defaults=(None,))
...
paddle.fluid.optimizer.DecayedAdagradOptimizer.create_optimization_pass ArgSpec(args=['self', 'parameters_and_grads', 'loss', 'startup_program'], varargs=None, keywords=None, defaults=(None,))
paddle.fluid.optimizer.DecayedAdagradOptimizer.global_learning_rate ArgSpec(args=['self', 'program'], varargs=None, keywords=None, defaults=(None,))
...
paddle.fluid.optimizer.FtrlOptimizer.create_optimization_pass ArgSpec(args=['self', 'parameters_and_grads', 'loss', 'startup_program'], varargs=None, keywords=None, defaults=(None,))
paddle.fluid.optimizer.FtrlOptimizer.global_learning_rate ArgSpec(args=['self', 'program'], varargs=None, keywords=None, defaults=(None,))
...
paddle.fluid.optimizer.RMSPropOptimizer.create_optimization_pass ArgSpec(args=['self', 'parameters_and_grads', 'loss', 'startup_program'], varargs=None, keywords=None, defaults=(None,))
paddle.fluid.optimizer.RMSPropOptimizer.global_learning_rate ArgSpec(args=['self', 'program'], varargs=None, keywords=None, defaults=(None,))
...
paddle.fluid.optimizer.AdadeltaOptimizer.create_optimization_pass ArgSpec(args=['self', 'parameters_and_grads', 'loss', 'startup_program'], varargs=None, keywords=None, defaults=(None,))
paddle.fluid.optimizer.AdadeltaOptimizer.global_learning_rate ArgSpec(args=['self', 'program'], varargs=None, keywords=None, defaults=(None,))
...
paddle.fluid.optimizer.ModelAverage.create_optimization_pass ArgSpec(args=['self', 'parameters_and_grads', 'loss', 'startup_program'], varargs=None, keywords=None, defaults=(None,))
paddle.fluid.optimizer.ModelAverage.global_learning_rate ArgSpec(args=['self', 'program'], varargs=None, keywords=None, defaults=(None,))
...
paddle.fluid.optimizer.Optimizer.__init__ ArgSpec(args=['self', 'learning_rate', 'regularization', 'LARS_weight_decay'], varargs=None, keywords=None, defaults=(None, 0.0))
paddle.fluid.optimizer.Optimizer.create_optimization_pass ArgSpec(args=['self', 'parameters_and_grads', 'loss', 'startup_program'], varargs=None, keywords=None, defaults=(None,))
paddle.fluid.optimizer.Optimizer.global_learning_rate ArgSpec(args=['self', 'program'], varargs=None, keywords=None, defaults=(None,))
paddle.fluid.optimizer.Optimizer.minimize ArgSpec(args=['self', 'loss', 'startup_program', 'parameter_list', 'no_grad_set'], varargs=None, keywords=None, defaults=(None, None, None))
...
paddle.fluid.backward.calc_gradient ArgSpec(args=['targets', 'inputs', 'target_gradients', 'no_grad_set'], varargs=None, keywords=None, defaults=(None, None))
